...
class Auth extends ShieldAuth
{
    ...
    public array $tables = [
        'users'             => 'ci_users',
        'identities'        => 'ci_identities',
        'logins'            => 'ci_logins',
        'token_logins'      => 'ci_token_logins',
        'remember_tokens'   => 'ci_remember_tokens',
        'groups_users'      => 'ci_groups_users',
        'permissions_users' => 'ci_permissions_users',
    ];
    ...
    public ?string $oldAuthKey1 = null;
    public ?string $oldAuthKey2 = null;
