...
import { defineComponent, ref, computed, resolveComponent, openBlock, createElementBlock, normalizeClass, withModifiers, createCommentVNode, createElementVNode, unref, toDisplayString, Fragment, renderList, createBlock, useCssVars, watch, nextTick } from "vue";
...
if (DataView$1 && getTag(new DataView$1(new ArrayBuffer(1))) != dataViewTag$1 || Map$1 && getTag(new Map$1()) != mapTag$2 || Promise$2 && getTag(Promise$2.resolve()) != promiseTag || Set$1 && getTag(new Set$1()) != setTag$2 || WeakMap$1 && getTag(new WeakMap$1()) != weakMapTag) {
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent(__spreadProps(__spreadValues({}, __default__$1), {
  ...
  setup(__props, { emit }) {
    ...
    function onNodeCLick(e, data) {
      ...
      emitter.emit("toggleSelectBar", e, data.selected ? "block" : "none");
    }
    function onContextmenu(e) {
      emitter.emit("contextMenu", e, selectNode.value);
    }
    function onRename(e, data) {
      const value = e.srcElement.value || "";
      data.text = value;
    }
    function onBlur(e, data) {
      data.rename = !data.rename;
    }
    return (_ctx, _cache) => {
      var _a, _b, _c, _d;
      const _component_tree_item = resolveComponent("tree-item", true);
      return !props.data.delete ? (openBlock(), createElementBlock("li", {
        key: 0,
        class: normalizeClass(["tree-node", {
          "is-opend": (_a = props.data) == null ? void 0 : _a.opended,
          "is-close": !((_b = props.data) == null ? void 0 : _b.opended)
        }]),
        role: "treeitem",
        onClick: _cache[4] || (_cache[4] = withModifiers((e) => onNodeCLick(e, props.data), ["stop"])),
        onMouseover: _cache[5] || (_cache[5] = withModifiers(($event) => props.data.isHover = !props.data.isHover, ["stop"])),
        onMouseout: _cache[6] || (_cache[6] = withModifiers(($event) => props.data.isHover = !props.data.isHover, ["stop"])),
        onContextmenu: _cache[7] || (_cache[7] = withModifiers((e) => onContextmenu(e), ["stop"]))
      }, [
        props.data.isHover ? (openBlock(), createElementBlock("div", _hoisted_1$1)) : createCommentVNode("", true),
        createElementVNode("i", {
          class: normalizeClass({
            "tree-anchor": unref(isFolder),
            "tree-node__icon": unref(isFolder)
          }),
          role: "presentation"
        }, null, 2),
        createElementVNode("div", {
          class: normalizeClass({
            "tree-anchor": true,
            "tree-selected": (_c = props.data) == null ? void 0 : _c.selected
          })
        }, [
          createElementVNode("i", {
            class: normalizeClass(["tree-node__icon", {
              "no-filder": !unref(isFolder)
            }]),
            role: "presentation"
          }, null, 2),
          !__props.data.rename ? (openBlock(), createElementBlock("span", _hoisted_2$1, toDisplayString(__props.data.text), 1)) : (openBlock(), createElementBlock("input", {
            key: 1,
            id: props.data.id + "",
            class: "tree-node__input",
            type: "text",
            value: __props.data.text,
            onInput: _cache[0] || (_cache[0] = (e) => onRename(e, props.data)),
            onBlur: _cache[1] || (_cache[1] = (e) => onBlur(e, props.data)),
            onClick: _cache[2] || (_cache[2] = withModifiers((e) => {
            }, ["stop"]))
          }, null, 40, _hoisted_3))
        ], 2),
        unref(isFolder) ? (openBlock(), createElementBlock("ul", _hoisted_4, [
          (openBlock(true), createElementBlock(Fragment, null, renderList((_d = props.data) == null ? void 0 : _d.children, (child, index2) => {
            return openBlock(), createBlock(_component_tree_item, {
              key: index2,
              data: child,
              menu: props.menu,
              onIconClick: _cache[3] || (_cache[3] = ($event) => props.data.opended = !props.data.opended)
            }, null, 8, ["data", "menu"]);
          }), 128))
...
var TreeItem = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-2e057d1a"]]);
class CreateMenu {
  constructor(menu) {
...
var tree_vue_vue_type_style_index_1_scoped_true_lang = "";
const _hoisted_1 = { role: "tree" };
const _hoisted_2 = {
  role: "group",
  class: "tree"
};
...
const _sfc_main = /* @__PURE__ */ defineComponent(__spreadProps(__spreadValues({}, __default__), {
  ...
  setup(__props) {
    const props = __props;
    useCssVars((_ctx) => ({
      "2431009a": selectBarDisplay.value,
      "cca955a6": selectBarTop.value
    }));
    let TREE_ID = 1;
    const selectBarTop = ref(0);
    const selectBarDisplay = ref("none");
    const treeData = ref([]);
    const targetTree = ref({});
    function formatItem(data, anchorID) {
      return data.map((item) => {
        const newData = {
          ...
          children: item.children ? formatItem(item.children, `${anchorID}-${TREE_ID - 1}`) : void 0,
          icon: item.icon || "",
    ...
    watch(() => props.data, (data) => {
      treeData.value = data.map((item) => {
        const data2 = {
          ...
          opended: item.opended || false,
          selected: item.selected || false,
          children: item.children ? formatItem(item.children, `${TREE_ID - 1}`) : void 0,
          icon: item.icon || "",
          rename: item.rename || false
        };
        return data2;
    ...
    function inputAutoFocus(treeID) {
      nextTick(() => {
    ...
    const menu = new CreateMenu([
      {
        ...
        onClick: function(e) {
          var _a;
          menu.hiddenMenu(e);
          (_a = targetTree.value.children) == null ? void 0 : _a.push(dir);
      ...
      },
      {
        ...
        onClick: function(e) {
          var _a;
          menu.hiddenMenu(e);
          (_a = targetTree.value.children) == null ? void 0 : _a.push(file);
    ...
    function toggleSelectBar(e, display) {
      selectBarTop.value = e.target.offsetTop;
      selectBarDisplay.value = display;
    }
    emitter.on("contextMenu", onContextmenu);
    emitter.on("toggleSelectBar", toggleSelectBar);
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        createElementVNode("ul", _hoisted_2, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(treeData.value, (child, index2) => {
...
var VTree = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-c4e428c6"]]);
var index = {
  install(app, options) {
    app.component(VTree.name, VTree);
  }
};
export { VTree, index as default };
