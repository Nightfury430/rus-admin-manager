    ...
    class GroundProjectedEnv extends THREE.Mesh {
        ...
        `;
            const uniforms = {
                ...
                offset_x:{
                    value: options?.offset_x || 200
                },
                offset_z:{
                    value: options?.offset_z || 200
                }
            };
        ...
        set offset_x(offset_x){
            this.material.uniforms.offset_x.value = offset_x;
        }
        get offset_x() {
            return this.material.uniforms.offset_x.value;
        }
        set offset_z(offset_z){
            this.material.uniforms.offset_z.value = offset_z;
        }
        get offset_z() {
            return this.material.uniforms.offset_z.value;
        }
        set radius( radius ) {
