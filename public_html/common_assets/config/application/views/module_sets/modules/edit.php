...
<form class="add_item" enctype="multipart/form-data" method="post" accept-charset="UTF-8" action="<?php echo site_url('module_sets/items_edit/'. $set_id . '/' . $top_category . '/' . $item['id']) ?>">
                    ...
                    <div id="tab-1" class="tab-pane active">
                        <div class="panel-body">
		                    ...
		                    <?php else:?>
                                ...
                                <input type="hidden" id="template_icon" name="template_icon" value="<?php echo $this->config->item('const_path') . $item['icon']?>">
		                    <?php endif;?>
                                ...
                                <div class="panel panel-default panel-body sizes_row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" min="0" class="form-control price_input" value="<?php echo $variant->price;?>">
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
...
<script src="/common_assets/admin_js/production/modules/modules_edit.js" type="text/javascript"></script>
