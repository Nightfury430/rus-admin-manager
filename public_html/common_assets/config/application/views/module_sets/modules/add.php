...
<div id="app">
    ...
    <form @submit="submit" id="sub_form" action="<?php echo site_url('module_sets/items_add_ajax/' . $set_id . '/') ?><?php if (isset($id)) echo $id ?>">
        <input id="form_success_url" value="<?php echo site_url('catalog/items/module_sets/' . $set_id) ?>" type="hidden">
        <input id="controller_name" value="module_sets" type="hidden">
                ...
                <div class="col-lg-12">
                    <div class="tabs-container">
                        <ul class="nav nav-tabs">
                            ...
                            <li><a class="nav-link" data-toggle="tab" href="#tab-6"><?php echo $lang_arr['accessories'] ?></a></li>
                            <li><a @click="get_default_furniture()" class="nav-link" data-toggle="tab" href="#tab-7"><?php echo $lang_arr['report_furniture'] ?></a></li>
                        </ul>
                                                ...
                                                <div v-if="editor_tabs.mode == 1">
                                                    ...
                                                    <div v-if="check_cabinet_type()">
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <label class="switch">
                                                                    <input @change="change_cabinet($event, 'shelves_auto', 'active')" :checked="get_type_params('sink', null, 'active')" type="checkbox">
                                                                    <span class="slider round"></span>
                                                                </label>
                                                            </div>
                                                        </div>
                        ...
                        <div class="ibox-content">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-4 col-sm-offset-2">
                                    <a class="btn btn-white btn-sm" href="<?php echo site_url('catalog/items/module_sets/' . $set_id . '/') ?>"><?php echo $lang_arr['cancel'] ?></a>
                                    <?php if (isset($id)): ?>
