<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2><?php echo $lang_arr['modules_set_categories_list']?> <?php echo $set['name']?></h2>
        <!--        <ol class="breadcrumb">-->
        ...
        <div class="col-lg-12">
            <div class="ibox ">
                ...
                <div class="ibox-content">
                    ...
                    <a class="btn btn-w-m btn-primary" href="<?php echo site_url('module_sets/categories_add/'.$set['id']) ?>" role="button"><?php echo $lang_arr['add_category']?></a>
                                            ...
                                            <li>
                                                <div class="list_div">
                                                    ...
                                                    <div class="actions_list">
                                                        ...
                                                        <a href="<?php echo site_url('module_sets/categories_edit/' . $set['id'] .'/'.$child['id']) ?>"><span class="glyphicon glyphicon-edit"></span></a>
                                                        <a class="delete_button" href="<?php echo site_url('module_sets/categories_remove/'. $set['id'] . '/' . $child['id']) ?>"><span class="glyphicon glyphicon-trash"></span></a>
                                                    </div>
                                                </div>
                                            </li>
						                <?php endforeach; ?>
