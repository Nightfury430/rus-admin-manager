        ...
        <div class="col-lg-12">
            <div class="ibox ">
                ...
                <div class="ibox-content">
                    <form class="" method="post" accept-charset="UTF-8" action="<?php echo site_url('facades/categories_add/') ?>">
                        ...
                        <div class="form-group">
                            <label for="name"><?php echo $lang_arr['order']?>*</label>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4 col-sm-offset-2">
                                <a class="btn btn-white btn-sm" href="<?php echo site_url('facades/categories_index/') ?>"><?php echo $lang_arr['cancel']?></a>
