<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2><?php echo $lang_arr['facades_items_heading']?></h2>
        <!--        <ol class="breadcrumb">-->
        ...
        <div class="col-lg-12">
            <div class="ibox ">
                ...
                <div class="ibox-content">
                    <div class="row">
                        <div class="col-sm-12">
                            <a class="btn btn-w-m btn-primary" href="<?php echo site_url('facades/item/') ?>" role="button"><?php echo $lang_arr['facades_items_add']?></a>
                            <a class="btn btn-w-m btn-success" href="<?php echo site_url('facades/items_catalog_index/') ?>" role="button"><?php echo $lang_arr['facades_items_add_from_catalog']?></a>
                            <a style="float:right" href="/common_assets/downloads/facades.zip" role="button"><?php echo $lang_arr['facades_items_download']?></a>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <form id="filter_form" method="post" accept-charset="UTF-8" action="<?php echo site_url('facades/items_index/') ?>">
                    ...
                    <table class="table table-hover table-bordered">
                        <thead>
                        <tr>
                            <th><?php echo $lang_arr['facade']?></th>
                            <th><?php echo $lang_arr['name']?></th>
                            <th><?php echo $lang_arr['category']?></th>
                            <th><?php echo $lang_arr['materials']?></th>
	                    ...
	                    <?php foreach ($items as $item):?>
                            <tr>
                                ...
                                <td>
				                    <?php
				                    $im = json_decode($item['materials']);

				                    foreach ($im as $item_material)
					                    foreach ($mats as $mat){
						                    if($mat['id'] == $item_material){
							                    echo $mat['name'] . '<br>';
						                    }
					                    }
				                    ?>
                                ...
                                <td>
                                    <div class="actions_list">
                                        <a href="<?php echo site_url('facades/item/' . $item['id']) ?>"><span class="glyphicon glyphicon-edit"></span></a>
                                        <a class="delete_button" href="<?php echo site_url('facades/items_remove/'. $item['id']) ?>"><span class="glyphicon glyphicon-trash"></span></a>
                                    </div>
                                </td>
                            </tr>
...
<script>
    $(document).ready(function () {
        ...
        $('.is_visible').click(function (e) {
            ...
            $.ajax({
                url: "<?php echo base_url('index.php/facades/set_active_ajax/')?>" + $(this).attr('data-id') + '/' + val,
                type: 'get'
            }).done(function(msg) {
                console.log(132)
            });
