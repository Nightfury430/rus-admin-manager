<div class="col-sm-12 col-md-12" id="content">
    ...
    <form class="add_item" enctype="multipart/form-data" method="post" accept-charset="UTF-8" action="<?php echo site_url('tech/items_add/') ?>">
        ...
        <a class="btn btn-danger" href="<?php echo site_url('tech/items_index/'.$_SESSION['selected_tech_items_category'].'/'.$_SESSION['selected_tech_items_per_page'].'/'.$_SESSION['selected_tech_items_pagination']) ?>"><?php echo $lang_arr['cancel']?></a>
    </form>
</div>
