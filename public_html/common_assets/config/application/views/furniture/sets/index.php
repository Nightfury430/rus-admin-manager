<div class="col-sm-12 col-md-12" id="content">
    <h3>Список вариантов фурнитуры</h3>



    <a class="btn btn-default" href="<?php echo site_url('furniture/sets_add/') ?>" role="button">Добавить вариант</a>
            ...
            <tr>
                ...
                <td>
                    <div class="actions_list">
                        <a href="<?php echo site_url('furniture/sets_edit/' . $item['id']) ?>"><span class="glyphicon glyphicon-edit"></span></a>
                        <a class="delete_button" href="<?php echo site_url('furniture/sets_remove/'. $item['id']) ?>"><span class="glyphicon glyphicon-trash"></span></a>
                    </div>
                </td>
            </tr>
