...
<form class="add_item" enctype="multipart/form-data" method="post" accept-charset="UTF-8" action="<?php echo site_url('modules/items_add/'.$top_category) ?>">
...
<script src="/common_assets/libs/csg.js" type="text/javascript"></script>
...
<!--<script src="/common_assets/js/v4/Washer.js" type="text/javascript"></script>-->
...
<script src="/common_assets/admin_js/production/modules_add_with_templates_v2.js" type="text/javascript"></script>
