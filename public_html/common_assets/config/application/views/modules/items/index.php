        ...
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <h5>
                        <?php echo $lang_arr['modules_list'] ?>
                    </h5>
                </div>
                <div class="ibox-content">
                    ...
                    <div class="row" style="margin-bottom: 15px">
                        <div class="col-sm-6">
                            <a class="btn btn-w-m btn-primary" href="<?php echo site_url('modules/items_add/') ?>" role="button"><?php echo $lang_arr['add_module']?></a>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <form id="filter_form" method="post" accept-charset="UTF-8" action="<?php echo site_url('modules/items_index/') ?>">
                                                    ...
                                                    <?php if($cat['parent'] == 0): ?>
                                                        ...
                                                        <?php if (isset($cat['children'])):?>
                                                            <?php foreach ($cat['children'] as $child):?>
                                                                <option <?php if($this->uri->segment(3) == $child['id']) echo 'selected';?> data-data='{"class": "sub_cat"}' value="<?php echo $child['id']?>"><?php echo $cat['name']?> / <?php echo $child['name']?></option>
                                                            <?php endforeach;?>
                                                        <?php endif;?>
                                                    <?php endif;?>
						                        <?php endforeach;?>
                    ...
                    <table class="table table-hover table-bordered">
                        ...
                        <tr>
                            ...
                            <th><?php echo $lang_arr['height']?></th>
		                ...
		                <?php foreach ($items as $item):?>
                            <tr>
                                ...
                                <td>
					                <?php
					                $tmp = json_decode($item['params']);
					                echo $tmp->params->variants[0]->height
					                ?>
                                </td>
                                <td>
					                <?php
                                ...
                                <td>
                                    <div class="actions_list">
                                        <a title="<?php echo $lang_arr['edit']?>" href="<?php echo site_url('modules/items_add/' . $item['id']) ?>"><span class="glyphicon glyphicon-edit"></span></a>
                                        <a title="<?php echo $lang_arr['delete']?>" class="delete_button" href="<?php echo site_url('modules/items_remove/' . $item['id']) ?>"><span class="glyphicon glyphicon-trash"></span></a>
                                    </div>
                                </td>
                            </tr>
                ...
                <div class="modal-content animated ">
                    ...
                    <div class="modal-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-2"> <button  id="bm_mass_depth" type="button" class="btn btn-primary" data-action="<?php echo site_url('modules/mass_modules_bottom/') ?>" ><?php echo $lang_arr['apply']?></button></div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-2"> <button id="bm_mass_fo" type="button" class="btn btn-primary" data-action="<?php echo site_url('modules/mass_modules_bottom/') ?>" ><?php echo $lang_arr['apply']?></button></div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-2"> <button id="bm_mass_bo" type="button" class="btn btn-primary" data-action="<?php echo site_url('modules/mass_modules_bottom/') ?>" ><?php echo $lang_arr['apply']?></button></div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-3"></div>
                            <div class="col-sm-3 text-center"><p style="margin-bottom: 3px"><?php echo $lang_arr['initial_value']?></p></div>
                            ...
                            <div class="col-sm-2"> <button id="bm_mass_height" type="button" class="btn btn-primary" data-action="<?php echo site_url('modules/mass_modules_bottom/') ?>" ><?php echo $lang_arr['apply']?></button></div>
                        </div>
                    </div>
                ...
                <div class="modal-content animated ">
                    ...
                    <div class="modal-body">
                        <div class="form-group d-flex flex-row align-items-center">
                            ...
                            <div class="p-2"> <button id="tm_mass_height" type="button" class="btn btn-primary" data-action="<?php echo site_url('modules/mass_modules_top/') ?>"><?php echo $lang_arr['apply']?></button></div>
                        </div>
                        <div class="form-group d-flex flex-row align-items-center">
                            ...
                            <div class="p-2"> <button id="tm_mass_depth" type="button" class="btn btn-primary" data-action="<?php echo site_url('modules/mass_modules_top/') ?>"><?php echo $lang_arr['apply']?></button></div>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-white" data-dismiss="modal"><?php echo $lang_arr['cancel']?></button>
...
<script>
    $(document).ready(function () {
        ...
        $('.is_visible').click(function (e) {
            ...
            $.ajax({
                url: "<?php echo base_url('index.php/modules/set_active_ajax/')?>" + $(this).attr('data-id') + '/' + val,
                type: 'get'
            }).done(function(msg) {
               console.log(132)
            });
