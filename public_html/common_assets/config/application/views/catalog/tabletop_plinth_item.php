                    ...
                    <div class="tab-content">
                        ...
                        <div id="params_tab" class="tab-pane">
                            <div class="panel-body">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">{{lang('length')}}, {{lang('units')}}/{{lang('price_type_pcs')}}</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">{{lang('depth')}}, {{lang('units')}}</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">{{lang('price_from_accs')}}</label>
                                    <div class="col-sm-10">
                                        <pp_items ref="price_acc_picker" @e_update="item.price_acc=$event" :unselect="true" :selected_item="item.price_acc" :lang="$options.lang" :controller="'accessories'"></pp_items>
                                    </div>
                                </div>



                                <div v-show="item.price_acc == 0" class="form-group row">
                                    <label class="col-sm-2 col-form-label">{{lang('price')}}</label>
                                    <div class="col-sm-10">
                                        <input type="number" v-model="item.price" min="0" step="1" class="form-control">
                                    </div>
                                </div>


                                <div class="form-group row">
                                    <label class="col-sm-12 col-form-label">{{lang('accessories')}}</label>
                                    <div class="col-sm-12">
                                        <pp_items ref="accessories_picker" @e_update="item.accs = $event" :count_mode="true" :unselect="true" :selected_items="item.accs" :controller="'accessories'"></pp_items>
                                    </div>
                                </div>
...
<script src="/common_assets/admin_js/vue/kitchen/tabletop_plinth_item.js?<?php echo md5(date('m-d-Y-His A e')); ?>"></script>
