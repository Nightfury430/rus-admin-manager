                    ...
                    <div class="ibox-content">
                        ...
                        <div class="tabs-container">
                            <ul class="nav nav-tabs">
                                ...
                                <li><a class="nav-link" data-toggle="tab" href="#tab-2"><?php echo $lang_arr['3dmodel']?></a></li>
                            ...
                            <div class="tab-content">
                                ...
                                <div id="tab-2" class="tab-pane">
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-4 col-form-label">{{lang('profile_handle')}}</label>
                                            <div class="col-sm-8">
                                                <div class="input-group">
                                                    <div  @click="process_model($event,'')" class="custom-file">
                                                        <input style="pointer-events: none" id="inputGroupFile01" type="file" accept=".fbx" @change="process_model($event,'handle')" class="custom-file-input">
                                                        <label style="pointer-events: none" class="custom-file-label" for="inputGroupFile01">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-4 col-form-label">{{lang('profile_vertical')}}</label>
                                            <div class="col-sm-8">
                                                <div class="input-group">
                                                    <div  @click="process_model($event,'')" class="custom-file">
                                                        <input style="pointer-events: none" id="inputGroupFile01" type="file" accept=".fbx" @change="process_model($event,'vertical')" class="custom-file-input">
                                                        <label style="pointer-events: none" class="custom-file-label" for="inputGroupFile01">

                                                            <span v-if="model_file.vertical.name">{{model_file.vertical.name}}</span>
                                                            <span v-else-if="item.params.models.vertical">{{item.params.models.vertical}}</span>
                                                            <span v-else>{{lang('no')}}</span>
                                                        </label>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-4 col-form-label">{{lang('profile_top')}}</label>
                                            <div class="col-sm-8">
                                                <div class="input-group">
                                                    <div  @click="process_model($event,'')" class="custom-file">

                                                            <input style="pointer-events: none" id="inputGroupFile02" type="file" accept=".fbx" @change="process_model($event,'top')" class="custom-file-input">
                                                            <label style="pointer-events: none" class="custom-file-label" for="inputGroupFile02">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-4 col-form-label">{{lang('profile_bottom')}}</label>
                                            <div class="col-sm-8">
                                                <div class="input-group">
                                                    <div  @click="process_model($event,'')" class="custom-file">
                                                        <input style="pointer-events: none" id="inputGroupFile03" type="file" accept=".fbx" @change="process_model($event,'bottom')" class="custom-file-input">
                                                        <label style="pointer-events: none" class="custom-file-label" for="inputGroupFile03">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-4 col-form-label">{{lang('profile_divider')}}</label>
                                            <div class="col-sm-8">
                                                <div class="input-group">
                                                    <div @click="process_model($event,'')" class="custom-file">
                                                        <input style="pointer-events: none" id="inputGroupFile04" type="file" accept=".fbx" @change="process_model($event,'divider')" class="custom-file-input">
                                                        <label style="pointer-events: none" class="custom-file-label" for="inputGroupFile04">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-4 col-form-label">{{lang('profile_slider_top')}}</label>
                                            <div class="col-sm-8">
                                                <div class="input-group">
                                                    <div @click="process_model($event,'')" class="custom-file">
                                                        <input style="pointer-events: none" id="inputGroupFile05" type="file" accept=".fbx" @change="process_model($event,'slider_top')" class="custom-file-input">
                                                        <label style="pointer-events: none" class="custom-file-label" for="inputGroupFile05">

                                                            <span v-if="model_file.slider_top.name">{{model_file.slider_top.name}}</span>
                                                            <span v-else-if="item.params.models.slider_top">{{item.params.models.slider_top}}</span>
                                                            <span v-else>{{lang('no')}}</span>
                                                        </label>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-4 col-form-label">{{lang('profile_slider_bottom')}}</label>
                                            <div class="col-sm-8">
                                                <div class="input-group">
                                                    <div @click="process_model($event,'')" class="custom-file">
                                                        <input style="pointer-events: none" id="inputGroupFile05" type="file" accept=".fbx" @change="process_model($event,'slider_bottom')" class="custom-file-input">
                                                        <label style="pointer-events: none" class="custom-file-label" for="inputGroupFile05">

                                                            <span v-if="model_file.slider_bottom.name">{{model_file.slider_bottom.name}}</span>
                                                            <span v-else-if="item.params.models.slider_bottom">{{item.params.models.slider_bottom}}</span>
                                                            <span v-else>{{lang('no')}}</span>
                                                        </label>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="panel-body">
                                        <div class="row form-group">
                                            <div class="col-12">
                                                ...
                                                <p class="alert alert-info">{{lang('profile_price_info')}}</p>

                                                <table v-for="(cat,cat_key) in item.params.prices" class="table table-bordered table-hover ">
                                                    <thead>
                                                    <tr>
                                                        <th></th>
                                                        <th >{{lang('profile_handle')}}</th>
                                                        <th>{{lang('profile_vertical')}}</th>
                                                        <th>{{lang('profile_top')}}</th>
                                                        <th>{{lang('profile_bottom')}}</th>
                                                        <th>{{lang('profile_divider')}}</th>
                                                        <th>{{lang('profile_slider_top')}}</th>
                                                        <th>{{lang('profile_slider_bottom')}}</th>
                                                    </tr>
                                                    </thead>
                                                    <tbody>
                                                    <tr>
                                                        <td class="text-danger text-center" colspan="8">ВНИМАНИЕ! Изменение значения в первой строке заменит цены во ВСЕМ столбце</td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <div><b>{{$options.materials_categories_hash[cat_key].name}}<b></div>
                                                        </td>
                                                        <td><input @input="change_column_price($event, cat_key, 'handle')" value="0" class="form-control" type="number" step="0.01" min="0"></td>
                                                        <td><input @input="change_column_price($event, cat_key, 'vertical')" value="0" class="form-control" type="number" step="0.01" min="0"></td>
                                                        <td><input @input="change_column_price($event, cat_key, 'top')" value="0" class="form-control" type="number" step="0.01" min="0"></td>
                                                        <td><input @input="change_column_price($event, cat_key, 'bottom')" value="0" class="form-control" type="number" step="0.01" min="0"></td>
                                                        <td><input @input="change_column_price($event, cat_key, 'divider')" value="0" class="form-control" type="number" step="0.01" min="0"></td>
                                                        <td><input @input="change_column_price($event, cat_key, 'slider_top')" value="0" class="form-control" type="number" step="0.01" min="0"></td>
                                                        <td><input @input="change_column_price($event, cat_key, 'slider_bottom')" value="0" class="form-control" type="number" step="0.01" min="0"></td>
                                                    </tr>
                                                    <tr v-if="$options.materials_items_hash[key]" v-for="(row,key) in item.params.prices[cat_key]">
                                                        <td>{{$options.materials_items_hash[key].name}}</td>
                                                        <td><input class="form-control" type="number" step="0.01" min="0" v-model="row.handle" ></td>
                                                        <td><input class="form-control" type="number" step="0.01" min="0" v-model="row.vertical" ></td>
                                                        ...
                                                        <td><input class="form-control" type="number" step="0.01" min="0" v-model="row.slider_top" ></td>
                                                        <td><input class="form-control" type="number" step="0.01" min="0" v-model="row.slider_bottom" ></td>
                                                    </tr>
                                                    </tbody>
                                                </table>
...
<!--                                                            <div v-bind:class="{ active: active_tab == index }" v-show="active_tab == index" v-for="(tab, index) in item.params.accessories" class="tab-pane">-->
                                                            <div v-bind:class="{ active: active_tab == index }" v-show="active_tab == index" v-for="(tab, index) in item.params.accessories" >
                                                                            ...
                                                                            <table v-if=" item.params.accessories[index]" class="table table-bordered table-hover ">
                                                                                ...
                                                                                <tr v-for="(it, ind) in item.params.accessories[index].items">
                                                                                    ...
                                                                                    <td class="text-center">
                                                                                        <button @click="remove_accessory(ind)" type="button" class="del_btn btn btn-w btn-danger btn-outline">
                                                                                            <span class="glyphicon glyphicon-trash"></span>
                                                                                        </button>
                                                                                    </td>
                                                                                </tr>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content ">
                    ...
                    <div class="modal-footer">
                        <button @click="acc_modal = false" type="button" class="btn btn-primary">{{lang('ok')}}</button>
