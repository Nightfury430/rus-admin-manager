...
<div v-cloak id="sub_form">
                    ...
                    <div class="ibox-content">
                        <div class="row align-items-center">
                            <div class="col-sm-6 d-flex align-items-center">
                                ...
                                <div v-if="is_catalog == 0" class="btn btn-sm btn-primary" @click="add_item()" role="button"><?php echo $lang_arr['add']?></div>
                                ...
                                <div v-show="is_modules" class="btn btn-sm btn-primary ml-1" data-toggle="modal" data-target="#mass_change_modal" role="button"><?php echo $lang_arr['mass_params_change']?> <?php echo $lang_arr['kitchen_bottom_modules']?></div>
                                <div v-show="is_modules" class="btn btn-sm btn-primary ml-1" data-toggle="modal" data-target="#mass_change_modal_top" role="button"><?php echo $lang_arr['mass_params_change']?> <?php echo $lang_arr['kitchen_top_modules']?></div>
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            <tr v-if="items[0]" v-for="(item,ind) in items">
                                ...
                                <td v-if="controller_name == 'modules_sets'">
                                    ...
                                    <a v-bind:href="base_url + '/catalog/categories_common/modules_sets_modules/' + item.id"> Редактировать категории </a>

                                </td>
                                <td v-if="controller_name == 'modules_sets'">
                                    <a v-bind:href="base_url + '/catalog/items_common/modules_sets_modules/' + item.id"> Редактировать модули </a>
                                </td>
                                <td v-if="controller_name == 'modules_sets'">
                                    <a v-bind:href="base_url + '/modules_sets_modules/preview_set/' + item.id"> Превью и иконки </a>
                                </td>

                                <td style="width: 150px">
                                    <template v-if="is_catalog == 0">
                                        <a :href="edit_item(item)"><i :title="lang('edit')"  class="fa fa-edit btn btn-outline btn-success"></i></a>
                                        <i style="margin: 0 6px" title="Копировать" @click="copy_item(item)" class="fa fa-copy btn btn-outline btn-info"></i>
    ...
    <div v-if="is_modules" class="modal inmodal" id="mass_change_modal" tabindex="-1" role="dialog">
    ...
    <div v-if="is_modules" class="modal inmodal" id="mass_change_modal_top" tabindex="-1" role="dialog">
...
<?php include($_SERVER['DOCUMENT_ROOT'] . '/common_assets/config/components/mass_materials_form.php');?>
