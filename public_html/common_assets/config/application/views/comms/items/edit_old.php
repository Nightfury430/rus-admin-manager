<div class="col-sm-12 col-md-12" id="content">
    <h3>Редактировать модель коммуникаций</h3>
    ...
    <form class="add_item" enctype="multipart/form-data" method="post" accept-charset="UTF-8" action="<?php echo site_url('comms/items_edit/'.$item['id']) ?>">
                                ...
                                <div class="col-xs-6">
                                    <div class="form-group">
                                        ...
                                        <select disabled class="form-control" name="stretch_width" id="stretch_width">
                                            ...
                                            <option <?php if($stretch_width == 1 ) echo 'selected'?> selected value="1"><?php echo $lang_arr['yes']?></option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-xs-6">
        ...
        <input class="btn btn-success" type="submit" value="<?php echo $lang_arr['save']?>"/>
