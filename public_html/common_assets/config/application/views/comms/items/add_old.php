<div class="col-sm-12 col-md-12" id="content">
    <h3>Добавить модель коммуникаций</h3>
    ...
    <form class="add_item" enctype="multipart/form-data" method="post" accept-charset="UTF-8" action="<?php echo site_url('comms/items_add/') ?>">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="group" id="group">
                        <option selected value="top"><?php echo $lang_arr['drag_as_top']?></option>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title"><?php echo $lang_arr['model_params']?></h4>
            </div>
            <div class="panel-body">
                <div class="row">
                    <div class="col-xs-4">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title"><?php echo $lang_arr['sizes']?></h4>
            </div>
            <div class="panel-body">
                ...
                <div class="panel panel-default panel-body sizes_row">
                    <div class="col-xs-4">
                        <div class="form-group">
                            ...
                            <input type="number" step="0.1" min="0" class="form-control width_input" id="model_width_0" value="">
                        </div>
                    </div>
                    <div class="col-xs-4">
                        <div class="form-group">
                            <label><?php echo $lang_arr['obj_height']?> (<?php echo $lang_arr['units']?>)</label>
                            <input type="number" step="0.1" min="0" class="form-control height_input" id="model_height_0" value="">
                        </div>
                    </div>
                    <div class="col-xs-4">
                        <div class="form-group">
                            <label><?php echo $lang_arr['obj_depth']?> (<?php echo $lang_arr['units']?>)</label>
                            <input type="number" step="0.1" min="0" class="form-control depth_input" id="model_depth_0" value="">
                        </div>
                    </div>
                </div>
        ...
        <a class="btn btn-danger" href="<?php echo site_url('comms/items_index/'.$_SESSION['selected_comms_items_category'].'/'.$_SESSION['selected_comms_items_per_page'].'/'.$_SESSION['selected_comms_items_pagination']) ?>"><?php echo $lang_arr['cancel']?></a>
    </form>
</div>
