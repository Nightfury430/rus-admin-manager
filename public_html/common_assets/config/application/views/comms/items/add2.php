<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2><?php echo $lang_arr['comms_item_add']?></h2>
        <!--        <ol class="breadcrumb">-->
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4 col-sm-offset-2">
                                <a class="btn btn-white btn-sm" href="<?php echo site_url('comms/items_index/'.$_SESSION['selected_comms_items_category'].'/'.$_SESSION['selected_comms_items_per_page'].'/'.$_SESSION['selected_comms_items_pagination']) ?>"><?php echo $lang_arr['cancel']?></a>
