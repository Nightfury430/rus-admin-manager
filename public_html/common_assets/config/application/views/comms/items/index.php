-<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2><?php echo $lang_arr['comms_item_index']?></h2>
        <!--        <ol class="breadcrumb">-->
        ...
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <h5><?php echo $lang_arr['comms_item_index'] ?></h5>
                </div>
                <div class="ibox-content">
                    <div class="row">
                        <div class="col-sm-12">
                            <a class="btn btn-w-m btn-default" href="<?php echo site_url('comms/items_add/') ?>" role="button"><?php echo $lang_arr['add_model']?></a>
                            <a class="btn btn-w-m btn-success" href="<?php echo site_url('comms/items_catalog_index/') ?>" role="button"><?php echo $lang_arr['facades_items_add_from_catalog']?></a>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <form id="filter_form" method="post" accept-charset="UTF-8" action="<?php echo site_url('comms/items_index/') ?>">
...
//                                print_r();
                                ...
                                <td>
                                    <div class="actions_list">
                                        <a href="<?php echo site_url('comms/items_add/' . $item['id']) ?>"><span class="glyphicon glyphicon-edit"></span></a>
                                        <a class="delete_button" href="<?php echo site_url('comms/items_remove/'. $item['id']) ?>"><span class="glyphicon glyphicon-trash"></span></a>
                                    </div>
                                </td>
                            </tr>
...
<script>
    $(document).ready(function () {
        ...
        $('.is_visible').click(function (e) {
            ...
            $.ajax({
                url: "<?php echo base_url('index.php/comms/set_active_ajax/')?>" + $(this).attr('data-id') + '/' + val,
                type: 'get'
            }).done(function(msg) {
                console.log(132)
            });
