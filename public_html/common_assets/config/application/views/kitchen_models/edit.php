<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2><?php echo $lang_arr['kitchen_model_edit']?></h2>
        <!--        <ol class="breadcrumb">-->
...
<form id="sub_form" enctype="multipart/form-data" method="post" accept-charset="UTF-8" action="<?php echo site_url('kitchen_models/edit/'.$item['id']) ?>">
    ...
    <?php
    $available_modules = $item['available_modules'];
    ?>


    <input type="hidden" id="js_item" value="<?php echo htmlentities(json_encode($item), ENT_QUOTES, 'UTF-8'); ?>">
    ...
    <div class="ibox">
        ...
        <div class="ibox-content sk-loading">
            ...
            <div class="form-group">
                ...
                <input value="<?php echo $item['name']?>" type="text" class="form-control" name="name" id="name" placeholder="<?php echo $lang_arr['name']?>">
            </div>

            <div class="form-group">
                <div>
                    <img style="max-width: 150px" src="<?php echo $this->config->item('const_path') . $item['icon'] ?>" alt="">
                </div>
        ...
        <div class="ibox-content sk-loading">
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="bottom_as_top_facade_models" id="bottom_as_top_facade_models">
                    <option <?php if($item['bottom_as_top_facade_models'] == 1) echo "selected"?> value="1"><?php echo $lang_arr['yes']?></option>
                    <option <?php if($item['bottom_as_top_facade_models'] == 0) echo "selected"?> value="0"><?php echo $lang_arr['no']?></option>
                </select>
            </div>
            ...
            <div class="form-group bottom_as_top_facade_materials">
                ...
                <select class="form-control" name="bottom_as_top_facade_materials" id="bottom_as_top_facade_materials">
                    <option <?php if($item['bottom_as_top_facade_materials'] == 1) echo "selected"?> value="1"><?php echo $lang_arr['yes']?></option>
                    <option <?php if($item['bottom_as_top_facade_materials'] == 0) echo "selected"?> value="0"><?php echo $lang_arr['no']?></option>
                </select>
            </div>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <select class="form-control" name="facades_models_top" id="facades_models_top">
                            ...
                            <?php foreach ($facades as $s_item):?>

                                <?php
                                $data_json = new stdClass();
                                $data_json->icon = get_asset_path($s_item['icon'], $this->config->item('const_path'));
                                $data_json->name = $s_item['name'];
                                ?>

                                <option data-data="<?php echo htmlentities(json_encode($data_json), ENT_QUOTES, 'UTF-8'); ?>"  value="<?php echo $s_item['id']?>"><?php echo $s_item['name']?></option>
                            <?php endforeach;?>
                        </select>
                    </div>
                </div>
        ...
        <div class="ibox-content sk-loading">
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="cokol_active" id="cokol_active">
                    <option <?php if($item['cokol_active'] == 0) echo "selected"?> value="0"><?php echo $lang_arr['yes']?></option>
                    <option <?php if($item['cokol_active'] == 1) echo "selected"?> value="1"><?php echo $lang_arr['no']?></option>
                </select>
            </div>

            <div class="form-group">
                <label for="cokol_height"><?php echo $lang_arr['cokol_default_height']?> (<?php echo $lang_arr['units']?>)</label>
                <input value="<?php echo $item['cokol_height']?>" type="number" step="1" class="form-control" id="cokol_height" name="cokol_height">
            </div>
            ...
            <div class="form-group" id="handle_selected_model_wrapper">
                ...
                <select class="form-control" name="handle_selected_model" id="handle_selected_model">
                    ...
                    <?php foreach ($handles as $handle):?>
                        ...
                        $data_json->name = $handle['name'];
                        ?>

                        <option data-data="<?php echo htmlentities(json_encode($data_json), ENT_QUOTES, 'UTF-8'); ?>" value="<?php echo $handle['id']?>"><?php echo $handle['name']?></option>
                    <?php endforeach;?>
                </select>
            </div>
            ...
            <div class="ibox-content sk-loading">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="cornice_available" id="cornice_available">
                        <option <?php if($item['cornice_available'] == 1) echo "selected"?> value="1"><?php echo $lang_arr['yes']?></option>
                        <option <?php if($item['cornice_available'] == 0) echo "selected"?> value="0"><?php echo $lang_arr['no']?></option>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="cornice_active" id="cornice_active">
                        <option <?php if($item['cornice_active'] == 1) echo "selected"?> value="1"><?php echo $lang_arr['yes']?></option>
                        <option <?php if($item['cornice_active'] == 0) echo "selected"?> value="0"><?php echo $lang_arr['no']?></option>
                    </select>
                </div>
            ...
            <div class="ibox-content sk-loading">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="available_modules" id="available_modules">
                        ...
                        <?php foreach ($module_sets as $s_item):?>
                            <option <?php if($available_modules == $s_item['id']) echo 'selected'?> value="<?php echo $s_item['id']?>"><?php echo $s_item['name']?></option>
                        <?php endforeach;?>
                    </select>
                </div>
        ...
        <div class="ibox">
            ...
            <div class="ibox-content sk-loading">
                ...
                <div class="form-group">
                    ...
                    <input type="text" value="<?php echo $item['fixed_materials']?>" class="form-control" id="fixed_materials" name="fixed_materials">
                </div>
...
<script src="/common_assets/admin_js/production/kitchen_model_edit.js?"<?php echo md5(date('m-d-Y-His A e'));?>></script>
