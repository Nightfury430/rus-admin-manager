<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2><?php echo $lang_arr['interior_categories_list']?></h2>
        <!--        <ol class="breadcrumb">-->
        ...
        <div class="col-lg-12">
            <div class="ibox ">
                ...
                <div class="ibox-content">
                    <a class="btn btn-w-m btn-primary" href="<?php echo site_url('interior/categories_add/') ?>" role="button"><?php echo $lang_arr['add_category']?></a>
                            ...
                            <li>
                                <div class="list_div">
                                    ...
                                    <div class="actions_list">
                                        ...
                                        <a href="<?php echo site_url('interior/categories_edit/' . $cat['id']) ?>"><span class="glyphicon glyphicon-edit"></span></a>
						                <?php if(!isset($cat['children'])):?>
                                            <a class="delete_button" href="<?php echo site_url('interior/categories_remove/'. $cat['id']) ?>"><span class="glyphicon glyphicon-trash"></span></a>
						                <?php else:?>
                                            ...
                                            <li>
                                                <div class="list_div">
                                                    ...
                                                    <div class="actions_list">
                                                        ...
                                                        <a href="<?php echo site_url('interior/categories_edit/' . $child['id']) ?>"><span class="glyphicon glyphicon-edit"></span></a>
                                                        <a class="delete_button" href="<?php echo site_url('interior/categories_remove/'. $child['id']) ?>"><span class="glyphicon glyphicon-trash"></span></a>
                                                    </div>
                                                </div>
                                            </li>
						                <?php endforeach; ?>
