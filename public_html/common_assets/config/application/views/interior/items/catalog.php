<div class="col-sm-12 col-md-12" id="content">
    <h3><?php echo $lang_arr['interior_items_list']?></h3>
...
//                                print_r();
                ...
                <td>
                    <div class="actions_list">
                        <a title="<?php echo $lang_arr['add_model_to_your_catalog']?>" class="add_item" href="<?php echo site_url('interior/add_item_from_catalog/' . $item['id']) ?>"><span class="glyphicon glyphicon-copy"></span></a>
                    </div>
                </td>
            </tr>
