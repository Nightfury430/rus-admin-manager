                    ...
                    <div class="tab-content">
                        <div id="tab-1" class="tab-pane active">
                            <div class="panel-body">
                                <div class="form-group row">
                                    <div class="col-12">
                                        <textarea name="custom_html" id="custom_html" class="form-control"  rows="15"><?php echo htmlspecialchars($custom_html) ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div id="tab-2" class="tab-pane">
                            <div class="panel-body">
                                ...
                                <div class="form-group row">
                                    <div class="col-12">
                                        <textarea name="custom_js" id="custom_js" class="form-control"  rows="15"><?php echo $custom_js?></textarea>
                                    </div>
                                </div>
                        ...
                        <div id="tab-3" class="tab-pane">
                            <div class="panel-body">
                                <div class="form-group row">
                                    <div class="col-12">
                                        <textarea name="custom_css" id="custom_css" class="form-control"  rows="15"><?php echo $custom_css?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
