...
<form id="sub_form" class="material_add" enctype="multipart/form-data" method="post" accept-charset="UTF-8" action="<?php echo site_url('materials/coupe_materials_items_edit/' . $item['id']) ?>">
                        ...
                        <div id="tab-1" class="tab-pane active">
                            <div class="panel-body">
                                <div class="form-group">
                                    ...
                                    <input id="name" type="text" class="form-control" name="name" placeholder="<?php echo $lang_arr['name']?>" value="<?php echo $item['name']?>">
                                </div>

                                <div class="form-group">
                                    <label for="name"><?php echo $lang_arr['code']?></label>
                                    <input id="code" type="text" class="form-control" name="code" placeholder="<?php echo $lang_arr['code']?>" value="<?php echo $item['code']?>">
                                </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#category')[0].selectize.setValue(JSON.parse('<?php echo $item['category']?>'))
