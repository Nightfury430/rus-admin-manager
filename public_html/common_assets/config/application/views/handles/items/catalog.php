<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2><?php echo $lang_arr['kitchen_handles_items']?></h2>
        <!--        <ol class="breadcrumb">-->
        ...
        <div class="col-lg-12">
            <div class="ibox ">
                <div class="ibox-title">
                    <h5><?php echo $lang_arr['kitchen_handles_items'] ?></h5>
                </div>
...
//                                print_r();
                                ...
                                <td>
                                    <div class="actions_list">
                                        <a data-toggle="modal" data-target="#myModal" title="<?php echo $lang_arr['add_model_to_your_catalog']?>" class="add_item" href="<?php echo site_url('handles/add_item_from_catalog/' . $item['id']) ?>"><span class="glyphicon glyphicon-copy"></span></a>
                                    </div>
                                </td>
                            </tr>
