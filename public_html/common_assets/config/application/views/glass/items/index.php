        ...
        <div class="col-lg-12">
            <div class="ibox ">
                ...
                <div class="ibox-content">
                    <div class="row">
                        <div class="col-sm-12">
                            <a class="btn btn-w-m btn-primary" href="<?php echo site_url('glass/items_add/') ?>" role="button"><?php echo $lang_arr['add']?></a>
                            <a class="btn btn-w-m btn-success" href="<?php echo site_url('glass/items_catalog_index/') ?>" role="button"><?php echo $lang_arr['add_from_catalog']?></a>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <form id="filter_form" method="post" accept-charset="UTF-8" action="<?php echo site_url('glass/items_index/') ?>">
                    ...
                    <table class="table table-hover table-bordered">
	                    ...
	                    <?php foreach ($items as $item):?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="actions_list">
                                        <a href="<?php echo site_url('glass/items_edit/' . $item['id']) ?>"><span class="glyphicon glyphicon-edit"></span></a>
                                        <a class="delete_button" href="<?php echo site_url('glass/items_remove/'. $item['id']) ?>"><span class="glyphicon glyphicon-trash"></span></a>
                                    </div>
                                </td>
                            </tr>
...
<script>
    $(document).ready(function () {
        ...
        $('.is_visible').click(function (e) {
            ...
            $.ajax({
                url: "<?php echo base_url('index.php/glass/set_active_ajax/')?>" + $(this).attr('data-id') + '/' + val,
                type: 'get'
            }).done(function(msg) {
                console.log(132)
            });
