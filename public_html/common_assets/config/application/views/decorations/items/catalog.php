...
<!--                                <option data-data='{"class": "top_cat"}' value="0">Все</option>-->
...
<!--                    <div class="col-xs-6">-->
<!--                        <div class="form-group">-->
<!--                            <label for="per_page">Количество на странице</label>-->
...
//                                print_r();
                ...
                <td>
                    <div class="actions_list">
                        <a title="<?php echo $lang_arr['add_model_to_your_catalog']?>" class="add_item" href="<?php echo site_url('tech/add_item_from_catalog/' . $item['id']) ?>"><span class="glyphicon glyphicon-copy"></span></a>
                    </div>
                </td>
            </tr>
