...
class Tech_model extends CI_Model {
    ...
    {
        $this->db->insert('Tech_categories', $data);
    ...
    public function categories_order_update($data)
    {
        ...
        $this->db->update_batch('Tech_categories', $data, 'id');
    }
    ...
    public function remove_category($id)
    {
        ...
        $delete = $this->db->delete('Tech_categories');
	...
	public function set_category_active( $id, $val ) {
		...
		if($cat['parent']){
			...
			if($parent['active']){
				$this->db->where('id', $id);
				$this->db->update('Tech_categories', array('active'=>$val));
    ...
    public function remove_items($id)
    {
        ...
        $delete = $this->db->delete('Tech_items');
        return $delete?true:false;
    }
	...
	public function set_active( $id, $val ) {
		$this->db->where('id', $id);
		$this->db->update('Tech_items', array('active'=>$val));
	}
    ...
    public function get_catalog_items()
    {
        ...
        $query = $this->db_common->get('Tech_items');
        return $query->result_array();
    }

    public function get_catalog_item($id)
    {
        $query = $this->db_common->get_where('Tech_items', array('id' => $id));
        return $query->row_array();
    }
...
//        $this->db_common->order_by('id','DESC');
        $query = $this->db_common->get('Tech_categories');
        return $query->result_array();
    }
