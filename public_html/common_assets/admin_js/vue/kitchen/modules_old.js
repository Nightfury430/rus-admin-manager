...
document.addEventListener('Glob_ready', function(){
    ...
    document.addEventListener("keydown", function(e){ if(e.which == 16) shift_pressed = 1 });
    document.addEventListener("keyup", function(e){ if(e.which == 16) shift_pressed = 0 });
    ...
    Promise.all(promises).then(function (results) {
        ...
        cat_ordered = flatten_tree(cat_tree);
    ...
    app = new Vue({
        ...
        methods: {
            sel_file: function(file){
                ...
                this.$refs[this.current_file_ref][this.current_file_index].value = glob.acc_url + file.true_path;
